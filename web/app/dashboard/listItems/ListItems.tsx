...
<Link href="/dashboard">
      <div className={`${path.startsWith('/dashboard') ? 'bg-green-500 text-white' : 'bg-blue-500 hover:bg-blue-700 text-white'} flex justify-center items-center pb-2 pt-2 pl-4 hover:bg-gray-100 w-full`}>
