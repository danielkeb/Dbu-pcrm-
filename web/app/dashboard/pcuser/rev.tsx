        ...
        <div className="flex flex-wrap">
          <div className="w-full lg:w-6/12 px-4">
            <div className="relative w-full mb-3">
              ...
              <div {...getRootProps({ className: "dropzone" })}>
                <input {...getInputProps()} />
                <p className="border-2 border-dashed border-blueGray-300 p-4 text-center">
          ...
          <div className="w-full lg:w-6/12 px-4">
            <div className="relative w-full mb-3">
              ...
              {capturing ? (
                <>
                  ...
                  <button
                    ...
                    className="bg-red-500 text-white font-bold uppercase text-xs px-4 py-2 rounded shadow hover:shadow-md outline-none focus:outline-none mt-3 mb-1"
                  >
                    Capture
                  </button>
                </>
              ...
              {imageSrc && (
                <img src={imageSrc} alt="Captured" className="mt-3"/>
                )}
              </div>
            </div>
          </div>
          ...
          <div className="text-center mt-6">
            <button
              type="submit"
              className="bg-blue-500 text-white active:bg-emerald-600 text-xs font-bold uppercase px-4 py-2 rounded shadow hover:shadow-md outline-none focus:outline-none mr-1 mb-1"
            >
              Submit
            </button>
          </div>
